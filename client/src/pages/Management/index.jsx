  ...
  return (
    <div className="management_page">
      <div className="management_page_header">
        <Header title="List Management" />
      </div>

      <Flex gap="middle" style={{ paddingTop: 20 }}>
        <div className="management_page_item">
          <Link to="/management/weddings">
            <img
              src={img_Wedding}
              alt="Wedding Hall"
      ...
      >
        ...
        <div className="management_page_text">
          <h2>Eden Rose</h2>
          <p>
            Offering luxurious wedding halls, diverse services, and delicious
            cuisine to make your special day unforgettable. Our venues blend
            elegance with modern amenities, ensuring comfort and style. Our
            catering service delights with varied menus, and our dedicated team
            ensures every detail is meticulously planned for a seamless
            celebration.
          </p>
        </div>
      </Flex>
      ...
      <AnimatedFlex
        className="management_flex"
        index={0}
        active={activeFlexIndex === 0}
      >
        <Flex gap="middle" style={{ marginTop: "5%" }}>
          ...
          <div className="management_hall_text">
            ...
            <p>
              Where love stories come to life. Our exquisite venue sets the
              stage for unforgettable celebrations, blending elegance with
              personalized touches. From intimate gatherings to grand affairs,
              let us turn your dream wedding into a magical reality.{" "}
            </p>
            <CustomButton
              className="btn_SeeDetail"
              name="See Detail"
              link="/management/weddings"
            />
          </div>
        </Flex>
      </AnimatedFlex>
      ...
      >
        ...
        >
          <div className="management_server_text">
            ...
            <p>
              Welcome to our exquisite wedding hall, where elegance meets charm.
              With its timeless decor and spacious layout, it sets the stage for
              unforgettable celebrations. From intimate gatherings to grand
              affairs, our hall is ready to host your dream wedding
            </p>
            <CustomButton
              className="btn_SeeDetail"
              name="See Detail"
              link="/management/halls"
            />
          </div>
      ...
      >
        <Flex gap="middle" style={{ marginTop: "5%" }}>
          ...
          <div className="management_hall_text">
            ...
            <p>
              Savor the moment with our exquisite cuisine, where every dish is a
              masterpiece of flavor and presentation. From appetizers to
              desserts, our menu is crafted to delight and impress, ensuring
              your wedding feast is nothing short of extraordinary.
            </p>
            <CustomButton
              className="btn_SeeDetail"
              name="See Detail"
      ...
      >
        ...
        >
          <div className="management_server_text">
            ...
            <p>
              Discover unmatched service tailored to perfection. Our dedicated
              team is here to ensure every aspect of your wedding day is
              seamless and unforgettable. Let us exceed your expectations and
